...
parser.add_argument(
    "--log_dir",
    type=str,
    default="/home/jliu/Desktop/RL/baselines/general/chainerrl/tensorboard",
)
...
parser.add_argument(
    "--save_dir",
    type=str,
    default="/home/jliu/Desktop/RL/baselines/general/chainerrl/models",
)
...
model = PPO("CnnPolicy", env, verbose=1, tensorboard_log=args.log_dir).learn(
